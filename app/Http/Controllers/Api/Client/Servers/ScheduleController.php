...
use Hexactyl\\Services\Schedules\ProcessScheduleService;
use Hexactyl\\Transformers\Api\Client\ScheduleTransformer;
use Hexactyl\\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/Hexactyl/panel/issues/2425
