...
use Hexactyl\\Transformers\Api\Client\TaskTransformer;
use Hexactyl\\Http\Requests\Api\Client\ClientApiRequest;
use Hexactyl\\Http\Controllers\Api\Client\ClientApiController;
use Hexactyl\\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Hexactyl\\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
    ...
    {
        $limit = config('Hexactyl.client_features.schedules.per_schedule_task_limit', 10);
