...
namespace Hexactyl\\Extensions\Spatie\Fractalistic;
...
use Hexactyl\\Extensions\League\Fractal\Serializers\HexactylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new HexactylSerializer();
        }
