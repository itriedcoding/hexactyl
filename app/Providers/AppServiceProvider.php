...
use Hexactyl\\Extensions\Themes\Theme;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        //
        // @see https://github.com/Hexactyl/panel/issues/3623
    ...
    public function register(): void
    {
        ...
        if (!config('Hexactyl.load_environment_only', false) && $this->app->environment() !== 'testing') {
