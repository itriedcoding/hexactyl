...
namespace Hexactyl\\Services\Allocations;
...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('Hexactyl.client_features.allocations.enabled')) {
    ...
    {
        $start = config('Hexactyl.client_features.allocations.range_start', null);
        $end = config('Hexactyl.client_features.allocations.range_end', null);
