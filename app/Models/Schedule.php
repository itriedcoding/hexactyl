 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \Hexactyl\\Models\Task> $tasks
 */
class Schedule extends Model
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Hexactyl\\Models\Task, $this>
     */
