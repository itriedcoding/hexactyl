...
namespace Hexactyl\\Console;

use Ramsey\Uuid\Uuid;
use Hexactyl\\Models\ActivityLog;
...
use Hexactyl\\Console\Commands\Schedule\ProcessRunnableCommand;
use Hexactyl\\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use Hexactyl\\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('Hexactyl.telemetry.enabled')) {
