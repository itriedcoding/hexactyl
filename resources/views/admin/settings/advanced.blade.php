...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Hexactyl.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="Hexactyl:guzzle:connect_timeout" value="{{ old('Hexactyl:guzzle:connect_timeout', config('Hexactyl.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="Hexactyl:guzzle:timeout" value="{{ old('Hexactyl:guzzle:timeout', config('Hexactyl.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="Hexactyl:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('Hexactyl:client_features:allocations:enabled', config('Hexactyl.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="Hexactyl:client_features:allocations:range_start" value="{{ old('Hexactyl:client_features:allocations:range_start', config('Hexactyl.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="Hexactyl:client_features:allocations:range_end" value="{{ old('Hexactyl:client_features:allocations:range_end', config('Hexactyl.client_features.allocations.range_end')) }}">
