...
namespace Hexactyl\\Tests\Integration\Services\Allocations;

use Hexactyl\\Models\Allocation;
use Hexactyl\\Tests\Integration\IntegrationTestCase;
use Hexactyl\\Services\Allocations\FindAssignableAllocationService;
use Hexactyl\\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use Hexactyl\\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('Hexactyl.client_features.allocations.enabled', true);
        config()->set('Hexactyl.client_features.allocations.range_start', 0);
        config()->set('Hexactyl.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('Hexactyl.client_features.allocations.range_start', 5000);
        config()->set('Hexactyl.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('Hexactyl.client_features.allocations.range_start', 5000);
        config()->set('Hexactyl.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('Hexactyl.client_features.allocations.range_start', 'hodor');
        config()->set('Hexactyl.client_features.allocations.range_end', 10);
        ...
        config()->set('Hexactyl.client_features.allocations.range_start', 10);
        config()->set('Hexactyl.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('Hexactyl.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
