...
namespace Hexactyl\\Tests\Integration\Services\Deployment;
...
use Hexactyl\\Services\Deployment\FindViableNodesService;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/Hexactyl/panel/issues/2529
     */
    ...
    {
        /** @var \Hexactyl\\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \Hexactyl\\Models\Node[] $nodes */
        $nodes = [
