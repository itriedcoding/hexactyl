...
namespace Hexactyl\\Tests\Integration\Api\Application;
...
use Hexactyl\\Tests\Traits\Integration\CreatesTestModels;
use Hexactyl\\Transformers\Api\Application\BaseTransformer;
use Hexactyl\\Transformers\Api\Client\BaseClientTransformer;
use Hexactyl\\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.Hexactyl.v1+json')
