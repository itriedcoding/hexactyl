...
use Hexactyl\\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up(): void
    {
        ...
        $subusers->each(function ($subuser) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('Hexactyl.api.key_expire_time', 720))->toDateTimeString(),
