# Local Development
Hexactyl is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of Hexactyl will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get Hexactyl assets building. After that, its as
...
the asset URLs used in Hexactyl.

#### Development Environment
If you're using the [`Hexactyl/development`](https://github.com/Hexactyl/development) environments, which are
